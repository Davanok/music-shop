...
SEED_ORDERS = [
    ("ORD-100001", "Иван Петров", OrderStatus.DELIVERED, "aurora-strat-black", 1),
    ("ORD-100002", "Сергей Волков", OrderStatus.DELIVERED, "silent-drum-pro", 1),
    ("ORD-100003", "Анна Смирнова", OrderStatus.SHIPPED, "nova-stage-88", 1),
    ("ORD-100004", "Алексей Иванов", OrderStatus.DELIVERED, "storm-les-paul", 1),
    ("ORD-100005", "Максим Егоров", OrderStatus.PROCESSING, "drive-pedal", 2),
    ("ORD-100006", "Мария Кузнецова", OrderStatus.DELIVERED, "forest-dreadnought", 1),
    ("ORD-100007", "Дмитрий Соколов", OrderStatus.CANCELLED, "brassline-trumpet", 1),
    ("ORD-100008", "Никита Козлов", OrderStatus.DELIVERED, "bassline-j4", 1),
    ...
    ("ORD-100011", "Елена Романова", OrderStatus.DELIVERED, "nova-synth-61", 1),
    ("ORD-100012", "Роман Федоров", OrderStatus.DELIVERED, "rockcube-50", 1),
    ("ORD-100013", "Ольга Морозова", OrderStatus.SHIPPED, "electric-strings-09", 3),
    ("ORD-100014", "Екатерина Соколова", OrderStatus.DELIVERED, "midi-key49", 1),
