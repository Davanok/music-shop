...
- История заказов открывается из аккаунта авторизованного пользователя без поля ввода электронной почты; администратор остается обычной пользовательской учетной записью и может пользоваться каталогом, корзиной, оформлением заказа и историей.
- Единый публичный вход используется для пользователей и администраторов; для роли `admin` дополнительно доступен экран администрирования.
- Административная панель имеет адаптивную трехколоночную компоновку: слева вертикальный выбор товаров, категорий, пользователей и заказов, в центре таблица выбранного раздела, справа форма выбранной или новой записи.
